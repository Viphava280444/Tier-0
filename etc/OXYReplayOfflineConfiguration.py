...
specifyStreams(tier0Config, ["PhysicsEGamma2"])
...
defaultCMSSWVersion = {"default": "CMSSW_15_0_9"}
...
for dataset in DATASETS:
    addDataset(tier0Config, dataset, do_reco=True, scenario=OXYScenario)
...
for dataset in DATASETS:
    addDataset(
        tier0Config, dataset, do_reco=False, raw_to_disk=False, scenario=OXYScenario
    )
...
for dataset in DATASETS:
    addDataset(tier0Config, dataset, do_reco=False, scenario=OXYScenario)
